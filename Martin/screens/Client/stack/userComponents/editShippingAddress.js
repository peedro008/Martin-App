    ...
    return(
        <ScrollView style={{flex:1, backgroundColor:"#FFF" }}>
            ...
            <View style={styles.container}> 
                ...
                <Input value={address}  onChangeText={value=>setAddress(value)} leftIcon={{type:"feather", name:"map-pin"}}/>
            </View>
            <View style={styles.container}> 
                <Text style={styles.text}>Apt / Suite / Other</Text>
                <Input value={apt_Suite}  onChangeText={value=>setApt_Suite(value)} leftIcon={{type:"feather", name:"home"}}/>
            </View>
            <View style={styles.container}> 
                <Text style={styles.text}>State / City</Text>
                <Input value={city}  onChangeText={value=>setCity(value)} leftIcon={{type:"feather", name:"map"}}/>
            </View>
            <View style={styles.container}> 
                <Text style={styles.text}>Postal Code</Text>
                <Input value={postalCode}  onChangeText={value=>setPostalCode(value)}  leftIcon={{type:"feather", name:"clipboard"}}/>
            </View>
            <View style={styles.container}> 
                <Text style={styles.text}>Phone</Text>
                <Input value={phone}  onChangeText={value=>setPhone(value)} leftIcon={{type:"feather", name:"phone"}}/>
            </View>
            </View>
